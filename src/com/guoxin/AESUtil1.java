...
public class AESUtil1 {
    ...
    public static String AESEncode(String encodeRules, String content) {
        try {
            ...
            System.out.println("original_key"+original_key);
            // 4.获得原始对称密钥的字节数组
            ...
            String AES_encode = new sun.misc.BASE64Encoder().encode(byte_AES);
    ...
    public static String AESDncode(String encodeRules, String content) {
        try {
            ...
            byte[] byte_content =  new sun.misc.BASE64Decoder().decodeBuffer(content);
    ...
    public static void main(String[] args) {
        AESUtil1 se = new AESUtil1();
        //Scanner scanner = new Scanner(System.in);
        /*
         * 加密1
         */

        String encodeRules = "bc0eb9b55d5b468a";
        String content = "shilei";
        ...
        encodeRules = "bc0eb9b55d5b468a";
        content = "aY17GDeWhLKwScwzlk8t8w==";
